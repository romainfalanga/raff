      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-red-600 to-red-700 shadow-lg">
        <div className="px-4 py-2">
          <Button
            ...
            size="sm"
            icon={Phone}
            className="w-full bg-white text-red-700 hover:bg-red-50 font-semibold shadow-md"
          >
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden lg:block">
              <Button
                onClick={() => setIsModalOpen(true)}
                variant="primary"
                className="shrink-0 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 ml-6"
              >
                Obtenir un devis
              </Button>
            </div>
